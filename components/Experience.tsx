      ...
      <div className="container mx-auto px-6 relative">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-4 flex justify-center items-center gap-4">
            ...
            <span className="text-white">Execution <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600">History</span></span>
          </h2>
          <p className="text-slate-400 font-mono text-sm border px-2 py-1 inline-block border-slate-700 rounded bg-dark-lighter">
          ...
          <div className="space-y-12">
            {experience.map((exp, index) => (
              ...
              >
                ...
                <div className="absolute left-[11px] md:left-1/2 transform md:-translate-x-1/2 top-8 w-6 h-6 bg-dark border-4 border-primary rounded-full z-10 shadow-[0_0_15px_rgba(59,130,246,0.8)]"></div>

                {/* Content Card */}
                <div className="md:w-1/2 pl-12 md:pl-0 md:px-12">
                  <div className="bg-dark-lighter border border-slate-700 p-6 rounded-sm hover:border-primary transition-all duration-300 relative group shadow-lg">
                     {/* Tech corner accents */}
                    ...
                    <div className="flex justify-between items-start mb-4 border-b border-slate-800 pb-2">
                      ...
                      <span className="text-slate-500 font-mono text-xs bg-slate-950 px-2 py-1 rounded border border-slate-800">
                        {exp.duration}
                      </span>
                    </div>
                    ...
                    <ul className="space-y-3">
                      {exp.details.map((detail, i) => (
                        <li key={i} className="text-slate-300 text-sm flex items-start gap-3 font-mono">
